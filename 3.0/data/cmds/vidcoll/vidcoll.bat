...
echo.
echo Nathan Evans - Wellerman (TikTok Sea Shanty) Official Audio
echo Uploaded by NathanEvanss
echo Video collection ID: vidcoll:wellerman
echo.
...
:vidcoll_dev_channel
echo.
echo vidcoll:dev_channel is tinyurl.com/MattoSubs
echo.
goto input

:vidcoll_wellerman
echo
echo vidcoll:wellerman is youtu.be/SLiNQhQr4G4